...
const Renderer =
  (EmployeeWindow.require && EmployeeWindow.require('electron')) ||
  EmployeeWindow.electron ||
  {};
/**
 * ipc
...
const cptext = Renderer.contextBridge || undefined;
/**
 * 是否为Electron环境
 */
const isELE = ipc ? true : false;
export { Renderer, ipc, isELE, cptext };
